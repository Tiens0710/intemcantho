 ...
 * Luxury premium design with asymmetric layout, hero section, and elegant contact form
 */

import { useState } from 'react';
import Navbar from '@/components/Navbar';
import { motion } from 'framer-motion';
import { ChevronRight, MapPin, Phone, Clock, Mail, Facebook, Instagram, Youtube, ChevronDown } from 'lucide-react';
  ...
  const faqs = [
    {
      ...
      answer: 'Có. Chúng tôi cung cấp dịch vụ thiết kế chuyên nghiệp, miễn phí hoặc tính phí tùy gói dịch vụ.',
    },
    {
      question: 'Tem in có chống nước, chống trầy không?',
      answer: 'Có. Chúng tôi cung cấp các loại tem chống nước, chống trầy, chống dầu tùy theo yêu cầu của khách hàng.',
    },
    {
      question: 'Thời gian in tem là bao lâu?',
      answer: 'Thời gian in tem tùy thuộc vào số lượng và độ phức tạp của thiết kế. Thường từ 2-5 ngày làm việc.',
    },
    {
      question: 'Duky Printing có nhận hoàn trả tem nhãn đã in không?',
      answer: 'Chúng tôi chỉ nhận hoàn trả nếu sản phẩm có lỗi do nhà in gây ra. Vui lòng liên hệ để thảo luận chi tiết.',
    },
    {
      question: 'Giá in tem được tính như thế nào?',
      answer: 'Giá in tem được tính dựa trên số lượng, kích thước, loại tem, và độ phức tạp của thiết kế. Vui lòng liên hệ để nhận báo giá chi tiết.',
    },
  ];
      ...
      <section className="relative overflow-hidden pt-12 md:pt-24 pb-16 md:pb-32">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="mb-6">
                <span className="text-sm font-light text-amber-800 tracking-wider uppercase">Liên hệ với chúng tôi</span>
              </div>
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <h3 className="text-base font-light text-gray-900 text-left">
                    {faq.question}
                  </h3>
                  <motion.div
          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              <p className="text-gray-600 font-light mt-4">
                Điền thông tin dưới đây và chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất.
              </p>
            </motion.div>
