/**
 * Packaging Products Category Page - Ấn phẩm bao bì
 * Product grid with sidebar categories and filtering
 * Same luxury premium style as other category pages
 */
            ...
            >
              <div className="bg-gray-50 rounded-sm p-6 sticky top-24">
                ...
                <div className="mt-8 pt-8 border-t border-gray-300">
                  <h3 className="text-sm font-light text-gray-900 mb-4 uppercase tracking-wide">Sắp xếp</h3>
                  <select
                    value={sortBy}
