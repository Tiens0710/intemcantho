...
const PRODUCTS: Product[] = [
  {
    ...
    description: 'High-quality tri-fold and multi-page brochures with vibrant colors and professional finishes.',
  ...
  },
  {
    ...
    description: 'Durable, waterproof labels perfect for product branding and packaging.',
    category: 'labels',
  ...
  },
  {
    ...
    description: 'Branded boxes, bags, and packaging solutions that elevate your product presentation.',
    category: 'packaging',
  ...
  },
  {
    ...
    description: 'Premium business cards with various finishes: matte, glossy, or textured.',
    category: 'office-products',
  ...
  },
  {
    ...
    description: 'Large-format standees for retail displays and event promotions.',
    category: 'display',
    image: 'https://images.unsplash.com/photo-1578500494198-246f612d03b3?w=500&h=500&fit=crop',
  ...
  },
  {
    ...
    description: 'Professional hang tags for clothing, accessories, and retail products.',
    category: 'labels',
    image: 'https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=500&h=500&fit=crop',
  ...
  },
  {
    ...
    description: 'Laminated and bound menus with custom designs for cafes and restaurants.',
    category: 'office-products',
    image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=500&h=500&fit=crop',
 ...
 */
export async function getFeaturedProducts(persona?: PersonaType): Promise<Product[]> {
 ...
 */
export async function searchProducts(query: string, persona?: PersonaType): Promise<Product[]> {
 ...
 */
export async function getRecommendations(persona: PersonaType): Promise<Product[]> {
  await new Promise((resolve) => setTimeout(resolve, 300));
