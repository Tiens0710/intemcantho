 ...
 * Smart welcome modal asking for user's profession/intent
 * Saves persona to global state for dynamic content personalization
 */

import { motion, AnimatePresence } from 'framer-motion';
import { useEffect, useState } from 'react';
import { PersonaType, getPersonaLabel } from '@/lib/wordpress';
...
export default function OnboardingModal() {
  ...
  const { persona, hasCompletedOnboarding, setPersona, setOnboardingComplete } = useAppStore();
