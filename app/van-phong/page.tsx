...
export default function OfficeProducts() {
  ...
  const products = [
    {
      id: 1,
      name: "Danh Thiếp Offset Cao Cấp",
      ...
      price: 150000,
      description: "Danh thiếp in offset chất lượng cao",
    },
    {
      id: 2,
      name: "Danh Thiếp Nổi 3D",
      category: "business-card",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-brochure-luxury-DDmwtYLkufziWByNSE9fSY.webp",
      price: 250000,
      description: "Danh thiếp nổi 3D độc đáo",
    },
    {
      id: 3,
      name: "Danh Thiếp Mạ Vàng",
      category: "business-card",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-packaging-luxury-RYsTx6Y8m5SoyfySkzLoUA.webp",
      price: 350000,
      description: "Danh thiếp mạ vàng sang trọng",
    },
    {
      id: 4,
      name: "Danh Thiếp Giấy Kraft",
      category: "business-card",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-labels-luxury-2gNgfReHpRXZq4kdAfZqaT.webp",
      price: 120000,
      description: "Danh thiếp giấy kraft tự nhiên",
    },
    {
      id: 5,
      name: "Danh Thiếp Bóng Mờ",
      category: "business-card",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-brochure-luxury-DDmwtYLkufziWByNSE9fSY.webp",
      price: 180000,
      description: "Danh thiếp bóng mờ hiện đại",
    },
    {
      id: 6,
      name: "Danh Thiếp Foil Bạc",
      category: "business-card",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-packaging-luxury-RYsTx6Y8m5SoyfySkzLoUA.webp",
      price: 280000,
      description: "Danh thiếp foil bạc lấp lánh",
    },
    {
      id: 7,
      name: "Danh Thiếp Cắt Đặc Biệt",
      category: "business-card",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-labels-luxury-2gNgfReHpRXZq4kdAfZqaT.webp",
      price: 320000,
      description: "Danh thiếp cắt theo hình đặc biệt",
    },
    {
      id: 8,
      name: "Danh Thiếp Nhũ Bạc",
      category: "business-card",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-brochure-luxury-DDmwtYLkufziWByNSE9fSY.webp",
      price: 200000,
      description: "Danh thiếp nhũ bạc tinh tế",
    },
    {
      id: 9,
      name: "Bao Thư Trắng Tiêu Chuẩn",
      category: "envelope",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-packaging-luxury-RYsTx6Y8m5SoyfySkzLoUA.webp",
      price: 50000,
      description: "Bao thư trắng tiêu chuẩn A4",
    },
    {
      id: 10,
      name: "Bao Thư Nâu Kraft",
      category: "envelope",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-labels-luxury-2gNgfReHpRXZq4kdAfZqaT.webp",
      price: 60000,
      description: "Bao thư nâu kraft tự nhiên",
    },
    {
      id: 11,
      name: "Folder Bìa Cứng",
      category: "folder",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-brochure-luxury-DDmwtYLkufziWByNSE9fSY.webp",
      price: 80000,
      description: "Folder bìa cứng chuyên nghiệp",
    },
    {
      id: 12,
      name: "Áo Đồng Phục Trắng",
      category: "uniform",
      image:
        "https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/service-packaging-luxury-RYsTx6Y8m5SoyfySkzLoUA.webp",
      price: 150000,
      description: "Áo đồng phục trắng cao cấp",
    },
  ];
