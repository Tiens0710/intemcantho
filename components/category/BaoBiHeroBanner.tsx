...
export default function BaoBiHeroBanner() {
  const [config, setConfig] = useState(DEFAULT_BANNERS["bao-bi"]);

  useEffect(() => {
    setConfig(getBannerConfig("bao-bi"));
  }, []);
  ...
  return (
    <CategoryMarketingHeroBanner
      ...
      breadcrumbs={[
        ...
        { label: "In Bao Bì", href: "/dich-vu/in-bao-bi", schemaItem: `${SITE_URL}/dich-vu/in-bao-bi` },
      ]}
      title={config.title}
