...
const fileRequirements = [
  "File thiết kế định dạng AI, PSD, CDR, PDF hoặc ảnh PNG/JPG chất lượng cao",
  "Độ phân giải 300dpi, hệ màu CMYK cho in offset",
  "Kích thước file đúng bằng kích thước thành phẩm + margin bleed 3mm",
  "Chữ đã convert outline, hình ảnh không bị vỡ khi phóng lớn",
  "Cung cấp mockup bao bì nếu cần thiết kế trọn gói",
];
...
const testimonials = [
  {
    id: 1,
    content:
      "Hộp giấy in rất đẹp, màu sắc đúng thiết kế. Đóng gói cẩn thận, giao hàng nhanh!",
    author: "Chị Ngọc",
    role: "Chủ thương hiệu trà thảo mộc",
    avatar:
      "https://ui-avatars.com/api/?name=Ngoc&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 2,
    content:
      "Túi giấy cao cấp, cán mờ sang trọng. Khách hàng feedback bao bì rất chuyên nghiệp.",
    author: "Anh Tuấn",
  ...
  },
  {
    id: 3,
    content:
      "In hộp carton số lượng lớn, chất lượng đồng đều. Giá cả hợp lý, sẽ hợp tác lâu dài.",
    author: "Chị Hương",
    role: "Chủ shop mỹ phẩm",
    avatar:
      "https://ui-avatars.com/api/?name=Huong&background=fcebdc&color=e6792a",
    rating: 5,
  },
];
...
export default function BaoBiFileAndFeedback() {
            ...
            >
              ...
              <div className="absolute top-4 right-4 opacity-[0.06]">
                <svg width="64" height="64" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M21 19V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V19M18 7L12 13M12 13L12 3M12 13L18 13"
                    stroke="#E6792A"
                    strokeWidth="1.5"
                    strokeLinecap="round"
              ...
              >
                ...
                >
                  YÊU CẦU FILE{" "}
                  <span style={{ color: "#E6792A" }}>IN BAO BÌ</span>
                </h2>
                <div
