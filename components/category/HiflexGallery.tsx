...
const galleryItems = [
  ...
  },
  {
    ...
    image: "/danhmuc5.png",
    category: "Backdrop",
    title: "Backdrop Hội Nghị",
  },
  {
    id: 4,
    image: "/danhmuc3.png",
    category: "Billboard",
    title: "Billboard Quảng Cáo",
  },
  {
    id: 5,
    image: "/danhmuc1.png",
    category: "Băng rôn",
    title: "Băng Rôn Khai Trương",
  },
  {
    id: 6,
    image: "/danhmuc6.png",
  ...
  },
  {
    ...
    image: "/danhmuc2.png",
    category: "Backdrop",
    title: "Backdrop Phóng Sự",
  },
  {
    id: 8,
    image: "/danhmuc4.png",
    category: "Billboard",
    title: "Billboard Đường Phố",
  },
];

export default function HiflexGallery() {
  ...
  return (
    <section className="relative py-16 bg-[#FAFAFA] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 max-w-[1400px]">
        ...
        >
          THƯ VIỆN MẪU{" "}
          <span className="text-[#e87c22]">BẠT HIFLEX</span>
        </h2>
        ...
        <div className="flex justify-center mt-10">
          <BrandOutlineButton active>Xem thêm mẫu Bạt Hiflex →</BrandOutlineButton>
        </div>
      </div>
    </section>
  );
