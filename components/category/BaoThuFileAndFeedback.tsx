...
const fileRequirements = [
  "Kích thước bao thư chuẩn: A4 (25x35cm), A5 (16x23cm), A6 (12x22cm)",
  "Lề an toàn tối thiểu 3-5mm cho đường gấp nắp và mép dán",
  "File gốc định dạng vector: PDF, AI, CDR (Corel) hoặc PSD (Photoshop)",
  "Độ phân giải hình ảnh tối thiểu 300dpi, hệ màu thiết kế CMYK",
  "Chữ (text) trong file cần được convert outline tránh lỗi mất font chữ",
];
...
const testimonials = [
  {
    id: 1,
    content:
      "Bao thư bế dán đều đặn, nắp dán sẵn keo 2 mặt cực kỳ tiện dụng cho việc gửi hợp đồng hàng ngày của công ty.",
    author: "Anh Đức",
    role: "Giám đốc vận hành Logistics",
    avatar:
      "https://ui-avatars.com/api/?name=Duc&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 2,
    content:
      "In màu logo rất chuẩn xác với màu thương hiệu cũ của bên mình. Giấy Ford in nhám cầm rất thích tay.",
    author: "Chị Vân",
    role: "Trợ lý hành chính văn phòng",
    avatar:
  ...
  },
  {
    id: 3,
    content:
      "Mẫu mã thiết kế bao thư đơn giản nhưng chuyên nghiệp. Đội ngũ Intem hỗ trợ sửa file nhiệt tình, giao hàng rất nhanh.",
    author: "Anh Tùng",
    role: "Quản lý chuỗi nha khoa",
    avatar:
      "https://ui-avatars.com/api/?name=Tung&background=fcebdc&color=e6792a",
    rating: 5,
  },
];
...
export default function BaoThuFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE{" "}
                  <span style={{ color: "#E6792A" }}>IN BAO THƯ</span>
                </h2>
                <div
