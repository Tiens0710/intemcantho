...
const fileRequirements = [
  "File dùng kích thước: Tùy theo yêu cầu (banner, backdrop, billboard...)",
  "Độ phân giải từ 70dpi – 300dpi tùy kích thước in",
...
const testimonials = [
  ...
  },
  {
    ...
    avatar:
      "https://ui-avatars.com/api/?name=Bich&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 3,
    content:
      "Banner hiflex có đèn rất nổi bật ban đêm, khách hàng khen đẹp. Giá cả phải chăng.",
    author: "Anh Đức",
    role: "Chủ nhà hàng",
    avatar:
...
export default function HiflexFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE{" "}
                  <span style={{ color: "#E6792A" }}>IN BẠT HIFLEX</span>
                </h2>
                <div
