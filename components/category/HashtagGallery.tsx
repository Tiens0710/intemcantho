...
const categories = ["Tất cả", "Check-in", "Sự kiện", "Thương hiệu"];

const galleryItems = [
  { id: 1, image: "/danhmuc2.png", category: "Check-in", title: "Hashtag check-in" },
  { id: 2, image: "/standee/section1_1.png", category: "Sự kiện", title: "Hashtag sự kiện" },
  { id: 3, image: "/standee/section1_2.png", category: "Thương hiệu", title: "Hashtag thương hiệu" },
  { id: 4, image: "/danhmuc4.png", category: "Check-in", title: "Hashtag khai trương" },
];
  ...
  return (
    <section className="relative overflow-hidden bg-[#FAFAFA] py-16">
      <div className="relative z-10 container mx-auto max-w-[1200px] px-4">
        ...
        >
          THƯ VIỆN MẪU <span className="text-[#e87c22]">HASHTAG</span>
        </h2>
