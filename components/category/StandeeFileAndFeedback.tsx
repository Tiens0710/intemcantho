...
const fileRequirements = [
  "File dùng kích thước: 160x60cm, 80x180cm hoặc 80x200cm",
...
const testimonials = [
  {
    id: 1,
    content:
      "Standee in rất sắc nét, màu đẹp, nhân viên tư vấn nhiệt tình. Giao đúng hẹn, sẽ ủng hộ lâu dài!",
    author: "Chị Hạnh",
  ...
  },
  {
    id: 2,
    content:
      "Giá hợp lý, chất lượng tốt. Dùng standee cuốn nhôm đi sự kiện rất tiện lợi.",
    author: "Anh Khoa",
...
export default function StandeeFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE{" "}
                  <span style={{ color: "#E6792A" }}>IN STANDEE</span>
                </h2>
                <div
