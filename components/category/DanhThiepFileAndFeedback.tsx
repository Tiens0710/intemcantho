...
const fileRequirements = [
  "Kích thước danh thiếp tiêu chuẩn: 90x55mm",
  "Độ phân giải 300dpi, hệ màu CMYK hoặc RGB",
  "File PDF, AI, PSD, CDR hoặc ảnh PNG/JPG chất lượng cao",
  "Nội dung rõ ràng, không lỗi chính tả, thông tin liên hệ chính xác",
  "Chữ đã convert outline, lề an toàn 2-3mm cho cắt/bế",
];
...
const testimonials = [
  {
    id: 1,
    content:
      "Danh thiếp in rất sắc nét, màu đẹp, nhân viên tư vấn nhiệt tình. Giấy cầm chắc tay, sẽ ủng hộ lâu dài!",
    author: "Chị Hạnh",
  ...
  },
  {
    id: 2,
    content:
      "Giá hợp lý, chất lượng tốt. Name card ép kim rất sang trọng, đối tác khen đẹp.",
    author: "Anh Khoa",
  ...
  },
  {
    id: 3,
    content:
      "In nhanh, hỗ trợ nhiệt tình, file chưa chuẩn cũng được hướng dẫn chỉnh lại rất kỹ. Rất hài lòng!",
    author: "Chị Mai",
...
export default function DanhThiepFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE{" "}
                  <span style={{ color: "#E6792A" }}>IN DANH THIẾP</span>
                </h2>
                <div
