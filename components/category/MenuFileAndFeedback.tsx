...
const fileRequirements = [
  "File dùng kích thước: A4 (21x29.7cm) hoặc kích thước tùy chọn",
...
const testimonials = [
  ...
  },
  {
    id: 2,
    content:
      "Giá hợp lý, chất lượng tốt. Menu bồi carton cứng cáp, sang trọng hơn hẳn.",
    author: "Chị Mai",
    role: "Chủ nhà hàng",
    avatar:
  ...
  },
  {
    ...
    author: "Anh Hùng",
    role: "Chủ quán trà sữa",
    avatar:
      "https://ui-avatars.com/api/?name=Hung&background=fcebdc&color=e6792a",
    rating: 5,
  },
];
...
export default function MenuFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE{" "}
                  <span style={{ color: "#E6792A" }}>IN MENU</span>
                </h2>
                <div
