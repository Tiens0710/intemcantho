...
const fileRequirements = [
  "Độ phân giải tối thiểu 300dpi để đảm bảo ảnh in ra sắc nét, không bị vỡ hạt",
  "File ảnh định dạng JPG, PNG chất lượng cao, hoặc file thiết kế Photoshop (PSD), PDF",
  "Tỷ lệ file thiết kế khớp với kích thước ảnh cần in (ví dụ: 10x15cm, 13x18cm, 15x21cm)",
  "Hệ màu ảnh RGB hoặc CMYK (hỗ trợ kiểm tra và chuyển màu tối ưu trước khi in)",
];
...
const testimonials = [
  {
    id: 1,
    content:
      "Ảnh ép nhựa cứng cáp, màu sắc hiển thị rất trung thực giống hệt file gốc trên điện thoại. Rất hài lòng!",
    author: "Chị Thảo",
    role: "Học sinh tại Cần Thơ",
    avatar:
      "https://ui-avatars.com/api/?name=Thao&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 2,
    content:
      "Shop xử lý ảnh rất nhanh, in và giao hàng trong ngày. Màng ép dẻo chống nước cực tốt.",
    author: "Anh Hoàng",
    role: "Freelancer thiết kế",
    avatar:
      "https://ui-avatars.com/api/?name=Hoang&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 3,
    content:
      "Chất lượng in ảnh cực tốt, bền màu. Đã làm cả bộ ảnh ép cứng gia đình để bàn trang trí phòng khách.",
    author: "Chị Hạnh",
    role: "Nội trợ",
    avatar:
...
export default function AnhEpNhuaFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE <span style={{ color: "#E6792A" }}>IN ẢNH ÉP</span>
                </h2>
                <div
