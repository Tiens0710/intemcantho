...
const galleryItems = [
  {
    id: 1,
    image: "/nhandan/bạn_hãy_làm_khôi_phục_202605181020.jpeg",
    category: "Tem chai lọ",
    title: "Tem nhãn chai lọ thủy tinh",
  },
  {
    id: 2,
    image: "/nhandan/bạn_hãy_làm_khôi_phục_202605181021.jpeg",
    category: "Tem hộp sản phẩm",
    title: "Tem nhãn hộp sản phẩm",
  },
  {
    id: 3,
    image: "/nhandan/danhmuc1.png",
    category: "Sticker - Decal",
    title: "Sticker decal dán sản phẩm",
  },
  {
    id: 4,
    image: "/nhandan/bạn_hãy_làm_khôi_phục_202605181020.jpeg",
    category: "Tem chống nước",
    title: "Tem decal nhựa chống nước",
  },
  {
    id: 5,
    image: "/nhandan/bạn_hãy_làm_khôi_phục_202605181021.jpeg",
    category: "Tem cuộn",
    title: "Tem nhãn cuộn sản xuất hàng loạt",
  },
  {
    id: 6,
    image: "/nhandan/danhmuc1.png",
    category: "Tem chai lọ",
    title: "Tem nhãn chai mỹ phẩm",
  },
];

export default function NhanDanGallery() {
  ...
  return (
    <section className="relative py-16 bg-[#FAFAFA] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 max-w-[1400px]">
        ...
        >
          MẪU TEM NHÃN{" "}
          <span className="text-[#e87c22]">PHỔ BIẾN</span>
        </h2>
