...
const fileRequirements = [
  "File ảnh cưới chất lượng gốc từ nhiếp ảnh gia (định dạng JPG, PNG, hoặc PSD)",
  "Độ phân giải tối thiểu 300dpi, kích thước khớp với khổ ảnh in (ví dụ: 60x90cm, 50x75cm)",
  "Ảnh đã được chỉnh sửa màu sắc và ánh sáng hoàn chỉnh để lên màu đẹp nhất",
  "Đội ngũ kỹ thuật sẽ hỗ trợ kiểm tra và tối ưu file ảnh cưới miễn phí trước khi in",
];
...
const testimonials = [
  {
    id: 1,
    content:
      "Ảnh cổng tráng gương lấp lánh như gương pha lê, ai đi tiệc cũng khen sang trọng và sắc nét.",
    author: "Chị Linh",
    role: "Cô dâu tại Cần Thơ",
    avatar:
      "https://ui-avatars.com/api/?name=Linh&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 2,
    content:
      "Khung ảnh cưới ép gỗ MDF rất chắc chắn, màu in đầm và ấm áp. Shop đóng gói cực kỳ cẩn thận và giao nhanh.",
    author: "Anh Quân",
    role: "Chú rể",
    avatar:
      "https://ui-avatars.com/api/?name=Quan&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 3,
    content:
      "Dịch vụ in ảnh cưới rất chuyên nghiệp, tư vấn nhiệt tình về các khổ ảnh và chất liệu phù hợp nhất.",
    author: "Chị Trang",
...
export default function AnhCuoiFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE <span style={{ color: "#E6792A" }}>IN ẢNH CƯỚI</span>
                </h2>
                <div
