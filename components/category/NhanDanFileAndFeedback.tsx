...
const fileRequirements = [
  "File dùng kích thước theo yêu cầu thực tế sản phẩm",
...
const testimonials = [
  ...
  },
  {
    ...
    avatar:
      "https://ui-avatars.com/api/?name=Lan&background=fcebdc&color=e6792a",
    rating: 5,
  },
];
...
export default function NhanDanFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE{" "}
                  <span style={{ color: "#E6792A" }}>IN TEM NHÃN</span>
                </h2>
                <div
