...
const fileRequirements = [
  "File thiết kế dùng đúng kích thước yêu cầu (ví dụ: 5x90cm cho đeo đầu, 20x80cm cho cầm tay)",
  "Hệ màu thiết kế CMYK hoặc RGB (hỗ trợ chuyển màu tối ưu cho in chuyển nhiệt)",
  "Định dạng file khuyên dùng: PDF, AI, PSD, CDR hoặc file ảnh độ phân giải cao PNG/JPG",
  "Chữ viết trong file cần được convert outline để tránh lỗi mất hoặc thay đổi font chữ",
];
...
const testimonials = [
  {
    id: 1,
    content:
      "Băng gôn in màu đỏ tươi rất đẹp, chữ vàng rõ ràng và nổi bật. Giao hàng cực kỳ đúng hẹn giúp hội cổ động kịp chuyến đi.",
    author: "Anh Tuấn",
    role: "Trưởng hội cổ động viên",
    avatar:
      "https://ui-avatars.com/api/?name=Tuan&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 2,
    content:
      "Đặt in băng gôn cầm tay cho team building công ty, vải satin bóng mượt và in chuyển nhiệt sắc nét. Chụp ảnh check-in cực đẹp.",
    author: "Chị Vân",
    role: "Quản lý nhân sự",
    avatar:
      "https://ui-avatars.com/api/?name=Van&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 3,
    content:
      "In nhanh, thiết kế chuyên nghiệp và hỗ trợ nhiệt tình. Sẽ tiếp tục hợp tác lâu dài với Intem Cần Thơ.",
    author: "Anh Phong",
    role: "Ban tổ chức giải chạy marathon",
    avatar:
      "https://ui-avatars.com/api/?name=Phong&background=fcebdc&color=e6792a",
    rating: 5,
  },
];
...
export default function BangGonFileAndFeedback() {
  ...
  return (
    <section ref={sectionRef} className="py-16 lg:py-20 bg-white relative overflow-hidden">
      <div
        ...
        style={{ background: "radial-gradient(circle, #E6792A 0%, transparent 70%)" }}
      />
      <div
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 4px 24px rgba(230,121,42,0.06), 0 1px 4px rgba(230,121,42,0.04)",
              }}
            >
              <div
                className="absolute top-0 left-0 right-0 h-1 rounded-t-2xl"
                style={{ background: "linear-gradient(90deg, #E6792A 0%, #f5c08a 50%, #E6792A 100%)" }}
              />
              ...
              >
                ...
                >
                  YÊU CẦU FILE <span style={{ color: "#E6792A" }}>IN BĂNG GÔN</span>
                </h2>
                <div
                  className="mx-auto mt-3 h-[3px] w-16 rounded-full"
                  style={{ background: "linear-gradient(90deg, transparent, #E6792A, transparent)" }}
                />
              </motion.div>
                  ...
                  >
                    <div className="flex-shrink-0 mt-0.5">
                      <motion.div
                        ...
                        style={{
                          background: "linear-gradient(135deg, #E6792A 0%, #f5a84a 100%)",
    ...
    >
      ...
      >
        <div
          ...
          style={{ background: "radial-gradient(ellipse at center, rgba(230,121,42,0.05) 0%, transparent 70%)" }}
        />
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg, transparent, #fcebdc, transparent)" }}
          />
