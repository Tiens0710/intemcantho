...
const fileRequirements = [
  "Khổ photobook chuẩn: 20x20cm, 30x30cm, 20x30cm hoặc kích thước tùy chỉnh",
  "Dàn trang theo thứ tự tăng dần, chừa lề gáy từ 10-15mm cho gáy mở phẳng",
  "File thiết kế định dạng PDF (gộp trang), AI, Indesign hoặc JPG chất lượng cao theo trang lẻ",
  "Độ phân giải hình ảnh tối thiểu 300dpi để đảm bảo các trang sách sắc nét",
];
...
const testimonials = [
  {
    id: 1,
    content:
      "Album photobook mở phẳng cực kỳ đẹp, gáy chắc chắn, màu sắc in ra nhìn rất sang và chân thực.",
    author: "Anh Nam",
    role: "Nhiếp ảnh gia tự do",
    avatar:
      "https://ui-avatars.com/api/?name=Nam&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 2,
    content:
      "Shop hỗ trợ dàn trang miễn phí, xếp bố cục ảnh rất có gu và chỉn chu. Rất ưng ý với cuốn album kỷ niệm gia đình này.",
    author: "Chị Phương",
    role: "Khách hàng tại Cần Thơ",
    avatar:
      "https://ui-avatars.com/api/?name=Phuong&background=fcebdc&color=e6792a",
    rating: 5,
  },
  {
    id: 3,
    content:
      "Giấy in ảnh dày dặn, cán màng mờ sờ rất mịn tay và hạn chế dính vân tay. Rất phù hợp lưu giữ những khoảnh khắc quý giá.",
    author: "Anh Bình",
    role: "Bố bỉm sữa",
    avatar:
      "https://ui-avatars.com/api/?name=Binh&background=fcebdc&color=e6792a",
    rating: 5,
  },
];
...
export default function PhotobookFileAndFeedback() {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  YÊU CẦU FILE <span style={{ color: "#E6792A" }}>IN PHOTOBOOK</span>
                </h2>
                <div
