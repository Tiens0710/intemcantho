/**
 * Home Page - Duky Printing - In Tem Nhãn Cần Thơ
 * Luxury premium aesthetic with label printing focus
 */
...
import { getTestimonials, getProcessSteps, Testimonial, ProcessStep } from '@/lib/wordpress';
...
export default function Home() {
  ...
  useEffect(() => {
    const loadData = async () => {
      const [testimonialData, processData] = await Promise.all([
        getTestimonials(),
        getProcessSteps(),
      ]);
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section id="services" className="py-24 md:py-32 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-sm tracking-widest text-amber-800 uppercase mb-4">DỊCH VỤ</p>
            <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-6">
              DỊCH VỤ CỦA DUKY
            </h2>
            <p className="text-lg text-gray-600 font-light">Mang lại sự bảo đảm cho từng sản phẩm</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-light text-amber-800 mb-1">{service.title}</h3>
                <p className="text-lg text-gray-700 font-light">{service.subtitle}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="best-seller" className="py-24 md:py-32 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <p className="text-sm tracking-widest text-amber-800 uppercase mb-4">BEST SELLER</p>
            <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-6">
              BEST SELLER
            </h2>
      ...
      <section id="why-us" className="py-24 md:py-32 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <p className="text-sm tracking-widest text-amber-800 uppercase mb-4">TẠI SAO</p>
            <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-6">
          ...
          >
            <h3 className="text-3xl font-light text-gray-900 mb-4">THIẾT KẾ & IN ẤN TEM NHÃN</h3>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/testimonial-bg-luxury-3Cfp27ranz9jLeeMgwmWFT.png)',
      ...
      >
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <p className="text-sm tracking-widest text-amber-800 uppercase mb-4">ĐÁNH GIÁ</p>
            <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              {
                content: 'In tem nhãn ở nhiều chỗ rồi, nhưng DuKy là nơi đầu tiên làm đúng màu và không làm mình chờ quá lâu. Rất ổn!',
                author: 'Khách hàng 1',
                role: 'Doanh nhân',
                rating: 5,
              },
              {
                content: 'Đã gửi nhiều file in cho khách, DuKy hỗ trợ kiểm tra trước khi in cực kỳ kỹ. Khỏi lo bị lỗi linh tinh. Đúng gu dân thiết kế!',
                author: 'Khách hàng 2',
                role: 'Nhà thiết kế',
                rating: 5,
              },
              {
                content: 'Hình ảnh rõ nét, màu không bị lệch khi in. Giấy cầm chắc tay, không bị mỏng quá. Chất lượng đúng như đã cam kết.',
                author: 'Khách hàng 3',
                role: 'Chủ cửa hàng',
                rating: 5,
              },
              {
                content: 'Tôi từng in tag ở nhiều nơi, nhưng chỉ khi làm việc với Duky mới thật sự hài lòng. Màu in chuẩn, font đúng thiết kế. Các bạn hỗ trợ chỉnh lại tốt.',
                author: 'Khách hàng 4',
      ...
      <section id="partners" className="py-24 md:py-32 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <p className="text-sm tracking-widest text-amber-800 uppercase mb-4">ĐỐI TÁC</p>
            <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-6">
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(https://d2xsxph8kpxj0f.cloudfront.net/90078694/ERMxTyYJFnFBQeNjeF6P4w/luxury-process-bg-V2u9F2ecQAVDmpt8voRMBo.webp)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
      ...
      >
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <p className="text-sm tracking-widest text-amber-800 uppercase mb-4">QUY TRÌNH</p>
            <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-6">
              QUY TRÌNH LÀM VIỆC
            </h2>
            <p className="text-lg text-gray-600 font-light">TỪ Ý TƯỞNG BAN ĐẦU - ĐẾN THIẾT KẾ HOÀN HẢO</p>
            <div className="w-16 h-1 bg-amber-800 mx-auto mt-6"></div>
          </motion.div>
      ...
      <section id="contact" className="py-24 md:py-32 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            >
              <p className="text-sm tracking-widest text-amber-800 uppercase mb-4">LIÊN HỆ</p>
              <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-6">
